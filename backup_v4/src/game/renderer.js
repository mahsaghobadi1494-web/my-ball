...
Renderer.prototype.drawVehicle = function (props, car, team) {
  ...
  var checkKey = W_cfg.radius + "_" + W_cfg.rest + "_" + W_cfg.attachX + "_" + W_cfg.attachY + "_" + W_cfg.attachZ + "_" + hideFlapsKey + "_" + flapOffsetYKey + "_" + flapScaleKey + "_" + flapWidthScaleKey + "_" + flapThickScaleKey + "_" + playerModelKey + "_" + playerWheelKey + "_" + playerHatKey + "_" + playerHornKey + "_" + playerToolKey + "_" + playerWingKey;
  ...
  var kitM = (props.carKit && props.carKit.models && (props.carKit.models[modelId] || props.carKit.models['OCTANE'])) || null;
  var kitW = (props.carKit && props.carKit.wheels && (props.carKit.wheels[wheelId] || props.carKit.wheels['SPORT'])) || null;
  ...
  // 8. Draw Equipped 3D Cosmetics (Hat, Horn, Tool, Wing)
  if (props.carKit && props.carKit.cosmetics) {
    ...
    if (cHat && cHat !== 'none' && props.carKit.cosmetics[cHat]) {
      this.draw(props.carKit.cosmetics[cHat], carDrawPos, B.quat, _vScale, {
    ...
    if (cHorn && cHorn !== 'none' && props.carKit.cosmetics[cHorn]) {
      this.draw(props.carKit.cosmetics[cHorn], carDrawPos, B.quat, _vScale, {
    ...
    if (cTool && cTool !== 'none' && props.carKit.cosmetics[cTool]) {
      this.draw(props.carKit.cosmetics[cTool], carDrawPos, B.quat, _vScale, {
    ...
    if (cWing && cWing !== 'none' && props.carKit.cosmetics[cWing]) {
      this.draw(props.carKit.cosmetics[cWing], carDrawPos, B.quat, _vScale, {
