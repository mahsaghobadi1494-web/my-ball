...
World.prototype.scoreGoal = function (scoringTeam, impactPos) {
  ...
  if (this.effects) {
    var celebId = (this.cfg && this.cfg.customization && this.cfg.customization.celebration) ? this.cfg.customization.celebration : "MASSIVE_EXPLOSION";
    if (typeof this.effects.playCelebration === "function") {
      this.effects.playCelebration(celebId, impactPos || this.ball.body.pos, scoringTeam);
    } else {
