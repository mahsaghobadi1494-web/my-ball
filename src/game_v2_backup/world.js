...
World.prototype.fixedStep = function (dt) {
  ...
  if (this.state === "COUNTDOWN") {
    ...
    this.stateTimer -= dt;
    if (this.stateTimer <= 0) {
      if (this.replay && this.replay.start(this.cfg.match.goalReplay || 4.0, 0.8)) {
        this.state = "REPLAY";
        this.stateTimer = (this.cfg.match.goalReplay || 4.0) / 0.8;
      } else {
  ...
  // Record Replay
  if (this.replay && (this.state === "PLAYING" || this.state === "GOAL")) {
