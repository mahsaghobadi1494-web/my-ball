...
Arena.prototype.build = function (R) {
  ...
  // Extend lush pitch grass all the way to the foot of the spectator stadium retaining wall (d = 6.0)
  var standBaseDist = 6.0;
  var apronIdx = [];
  ...
  var gTiers = [
    // 1. Concrete Retaining Wall perimeter (vertical wall at d=6.0 from ground y=0 to walkway y=4.2)
    { d0: 6.0, y0: 0.0, d1: 6.0, y1: 4.2, v0: 0.00, v1: 0.08 },
    // 2. Lower Concourse Promenade Walkway (d=6.0 to d=8.5 at y=4.2)
    { d0: 6.0, y0: 4.2, d1: 8.5, y1: 4.2, v0: 0.08, v1: 0.12 },
    // 3. Tier 1 - Lower Seating Bowl (Raking from y=4.2 to y=15.2 filled with cheering fans)
    { d0: 8.5, y0: 4.2, d1: 22.0, y1: 15.2, v0: 0.12, v1: 0.42 },
    // 4. Middle Concourse Walkway (d=22.0 to d=24.5 at y=15.2)
    { d0: 22.0, y0: 15.2, d1: 24.5, y1: 15.2, v0: 0.42, v1: 0.46 },
    // 5. Tier 2 - Middle Seating Bowl (Raking from y=16.2 to y=27.2)
    { d0: 24.5, y0: 16.2, d1: 40.0, y1: 27.2, v0: 0.46, v1: 0.72 },
    // 6. Upper Balcony Concourse Walkway (d=40.0 to d=42.5 at y=27.2)
    { d0: 40.0, y0: 27.2, d1: 42.5, y1: 27.2, v0: 0.72, v1: 0.76 },
    // 7. Tier 3 - Upper Deck (Raking from y=28.2 to y=39.2)
    { d0: 42.5, y0: 28.2, d1: 57.0, y1: 39.2, v0: 0.76, v1: 0.96 },
    // 8. Majestic Stadium Canopy Overhang
    { d0: 57.0, y0: 39.5, d1: 26.0, y1: 46.0, v0: 0.96, v1: 1.00 }
  ];
